...
.stApp, .stApp p, .stApp label { color: #1a202c !important; }
[data-testid="stMetricValue"] { color: #2b6cb0 !important; font-weight: 700 !important; }
[data-testid="stMetricLabel"] { color: #4a5568 !important; }
.stTabs [data-baseweb="tab"] { color: #4a5568 !important; }
.stTabs [aria-selected="true"] { color: #2b6cb0 !important; border-bottom-color: #2b6cb0 !important; }
.stNumberInput input, .stTextInput input { background: #ffffff !important; border: 1px solid #cbd5e0 !important; border-radius: 6px !important; }
.stDownloadButton button { background: #2b6cb0 !important; color: #ffffff !important; font-weight: 700 !important; border-radius: 6px !important; }
